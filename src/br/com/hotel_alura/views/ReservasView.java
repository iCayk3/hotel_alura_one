	...
	public ReservasView() {
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				try{
					//System.out.println(txtDataE.getDate().toString());
					Reserva reserva = new Reserva();
					txtValor.setText(Float.toString(reserva.calcularValor(txtDataE.getDate(), txtDataS.getDate())));
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtDataE.getDate() != null && ReservasView.txtDataS.getDate() != null) {
					Reserva reserva = new Reserva(txtDataE.getDate().toString(), txtDataS.getDate().toString(), (String) txtFormaPagamento.getSelectedItem());
					try {
						reserva.setValor(reserva.calcularValor(txtDataE.getDate(), txtDataS.getDate()));
					...
					ControllerReserva ctrlReserva = new ControllerReserva();
					ctrlReserva.salvar(reserva);
