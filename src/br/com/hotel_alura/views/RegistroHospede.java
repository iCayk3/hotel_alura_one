...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		txtNreserva.setText(Integer.toString(ctrlReserva.pegarUltimaReserva().getId()));
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ControllerReserva ctrlReserva = new ControllerReserva();
				ControllerHospede ctrlHospede = new ControllerHospede();
				//Salvar clientee
				Hospede hospede = new Hospede(txtNome.getText(), txtSobrenome.getText(), 
						FormatarData.formatarData(txtDataN.getDate().toString()), (String)txtNacionalidade.getSelectedItem(), 
						txtTelefone.getText(), ctrlReserva.pegarUltimaReserva());
				
				ctrlHospede.salvar(hospede);
